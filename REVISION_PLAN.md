...
todos:
  ...
  - id: rev4
    ...
    status: completed
  - id: rev5
    content: "Revision 5 P0 (14 Aug): athletic testing library, observation tags, Required/Optional/Not-Offered, module completion + ready-for-submission, positions-today, staffing calc + warnings, N/O|N/A|DNP|Retest — deployed 14 Aug; P1 (waves/equipment/rotations) and AI-assessment gating pending"
    status: completed
  - id: rev3
