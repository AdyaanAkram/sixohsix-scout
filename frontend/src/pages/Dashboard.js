        ...
        <Card className="rounded-2xl border-border overflow-hidden">
          ...
          <CardContent className="pt-4 pb-5">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <StatCard label="Evaluations Completed" value={stats.evaluations_completed} icon={ClipboardCheck} accent="hsl(var(--info))" testId="stat-evals-completed" />
              <StatCard label="Drafts In Progress" value={stats.evaluations_draft} icon={Activity} accent="hsl(var(--warning))" testId="stat-evals-draft" />
            </div>
          </CardContent>
        </Card>
      ) : (
